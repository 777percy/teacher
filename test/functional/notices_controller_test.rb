...
class NoticesControllerTest < ActionController::TestCase
  ...
  test "should create notice" do
    assert_difference('Notice.count') do
      post :create, notice: { contenido: @notice.contenido, image: @notice.image, resumen: @notice.resumen, titulo: @notice.titulo }
    end
  ...
  test "should update notice" do
    put :update, id: @notice, notice: { contenido: @notice.contenido, image: @notice.image, resumen: @notice.resumen, titulo: @notice.titulo }
    assert_redirected_to notice_path(assigns(:notice))
  end
